...
- **<private-tracker>** — private tracker. We now maintain a seed/ratio here, so **do not
  ...
  Grabs from <private-tracker> are currently **manual** (no Prowlarr indexer): download the
